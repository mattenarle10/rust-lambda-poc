...
Once you're comfortable with this single-function Lambda deployed via Cargo Lambda, the next repo in the series is [`rust-lambda-cdk-s3-poc`](https://github.com/mattenarle10/rust-lambda-cdk-s3-poc), which:
